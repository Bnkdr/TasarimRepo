...
namespace TasarimRepo
{
    class SeçilenOgrenci
    {
        ...
        public SeçilenOgrenci()
        {
        }

        public SeçilenOgrenci(int sirano, string isim, string soyisim, int numara, int sınıf, char şube, bool yatılılık)
        {
            this.sirano = sirano;
            this.isim = isim;
        ...
        public SeçilenOgrenci(int sirano, string isim, string soyisim, int numara, int sınıf, char şube, bool yatılılık, long telno, string anneisim, string annemeslek, long annetelno, long babatelno, string hobi, double girişyüzdesi, long tcno, string babaisim, string babameslek)
        {
            this.sirano = sirano;
            this.isim = isim;
            this.soyisim = soyisim;
